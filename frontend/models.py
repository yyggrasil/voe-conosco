...
class flights(models.Model):
    flight_iata = models.CharField(max_length=3, null=True, blank=True)
    ...
    departure_iata = models.CharField(max_length=3, null=True, blank=True)
    ...
    arrival_iata = models.CharField(max_length=3, null=True, blank=True)
